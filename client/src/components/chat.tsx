...
export default function Page({ agentId }: { agentId: UUID }) {
    ...
    return (
        <div
            className={cn(
                "flex flex-col w-full px-4 md:px-8 lg:px-20 max-w-5xl mx-auto",
                isOpen ? "h-[calc(100dvh-5rem)]" : "h-[calc(100dvh-3rem)]",
            )}
        >
            ...
            <div className="px-4 pb-2 sticky bottom-0">
                <form
                    ref={formRef}
                ...
                <p className="text-xs text-muted-foreground text-center mt-2 opacity-50">
                    Quantix is powered by Injective and ElizaOS
                </p>
            </div>
        </div>
    );
