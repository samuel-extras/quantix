                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-black/70 dark:text-white/70 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Gitstark is your AI-powered GitHub assistant that
                            helps you reward contributors with{" "}
                            <strong className="font-bold">
                                STRK OR LORDS tokens
                            </strong>
                            . Automate PRs, issues, and more while seamlessly
                            distributing STRK or LORDS tokens to recognize and
