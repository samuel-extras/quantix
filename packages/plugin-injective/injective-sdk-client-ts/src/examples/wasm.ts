...
export const msgStoreCodeExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xstorecodehash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgUpdateAdminExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xupdateadminhash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgExecuteContractExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xexecutecontracthash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgMigrateContractExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xmigratecontracthash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgInstantiateContractExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xinstantiatecontracthash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgExecuteContractCompatExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xexecutecompathash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgPrivilegedExecuteContractExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xprivilegedexecutehash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
				...
				events: [
					{
						...
						blockHeight: 1000000,
						txHash:
							"0xeventtxhash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
					},
				],
				pagination: {
					nextKey: "xyz789...",
