    ...
    [
        {
            user: "{{user1}}",
            content: {
                text: "Show me my subaccount history.",
            },
        },
        {
            user: "Quantix",
            content: {
                text: "Sure. Please provide your subaccount ID. Optionally, you can specify a token denom (e.g., INJ), transfer types (e.g., deposit, withdraw), and pagination options like page number and limit.",
            },
        },
        {
            user: "{{user1}}",
        ...
        },
        {
            user: "Quantix",
            content: {
                text: "Denom refers to the specific token symbol you want to filter the history by, such as INJ for Injective, USDT for Tether, etc. If you leave it empty, I'll return the history for all tokens.",
            },
        },
    ],
    [
        {
            user: "{{user1}}",
            content: {
                text: "Get the subaccount history.",
            },
        },
        {
            user: "Quantix",
            content: {
                text: "I can do that. Please provide your subaccount ID. You can also specify a token denom, transfer types, and pagination options (page number and limit).",
            },
        },
        {
            user: "{{user1}}",
            content: {
                text: "Just get everything.",
            },
        },
        {
            user: "Quantix",
            content: {
                text: "Okay. I'll fetch the complete history for your default subaccount using default settings: denom: 'inj',  transferType: ['deposit', 'withdraw'], and pagination starting at page 1 with 10 results per page. Do you want me to proceed?",
            },
        },
        {
            user: "{{user1}}",
    ...
    [
        {
            user: "{{user1}}",
            content: {
                text: "What data do you need to get my subaccount history?",
            },
        },
        {
            user: "Quantix",
            content: {
                text: "I need your subaccount ID. Optionally, you can also provide a token denom to filter by e.g 'INJ', specify transfer types like deposit or withdraw e.g [ 'deposit', 'withdraw' ], and set pagination options like page number and limit",
            },
        },
    ],
    [
        {
            user: "{{user1}}",
            content: {
                text: "Get my subaccount history for subaccount ABC123",
            },
        },
        {
            user: "Quantix",
    ...
    [
        {
            user: "{{user1}}",
            content: {
                text: "Get my subaccount history for subaccount ABC123, denom INJ, transfer type deposit and withdraw, page 1, limit 20.",
            },
        },
        {
            user: "Quantix",
