...
export const msgSubmitProposalExpiryFuturesMarketLaunchExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xsubmitproposalexpiryfutureshash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgSubmitProposalSpotMarketLaunchExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xsubmitproposalspotmarkethash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgSubmitProposalPerpetualMarketLaunchExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xsubmitproposalperpetualmarkethash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgSubmitTextProposalExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xsubmittextproposalhash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgSubmitProposalSpotMarketParamUpdateExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xsubmitproposalspotmarketparamupdatehash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgSubmitGenericProposalExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xsubmitgenericproposalhash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
...
export const msgGovDepositExample = [
	...
	},
	{
		...
		content: {
			...
			content: {
				txHash:
					"0xgovdeposithash123def456ghi789jkl012mno345pqr678stu901vwx234yz",
				success: true,
			},
		},
	},
