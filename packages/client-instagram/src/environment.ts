...
export const instagramEnvSchema = z.object({
	...
	INSTAGRAM_POST_INTERVAL_MIN: z
		.number()
		.int()
		.default(DEFAULT_POST_INTERVAL_MIN),
	INSTAGRAM_POST_INTERVAL_MAX: z
		.number()
		.int()
		.default(DEFAULT_POST_INTERVAL_MAX),
...
export async function validateInstagramConfig(
	...
	try {
		const instagramConfig = {
			...
			INSTAGRAM_USERNAME:
				runtime.getSetting("INSTAGRAM_USERNAME") ||
				process.env.INSTAGRAM_USERNAME,

			INSTAGRAM_PASSWORD:
				runtime.getSetting("INSTAGRAM_PASSWORD") ||
				process.env.INSTAGRAM_PASSWORD,

			INSTAGRAM_APP_ID:
				runtime.getSetting("INSTAGRAM_APP_ID") || process.env.INSTAGRAM_APP_ID,

			INSTAGRAM_APP_SECRET:
				runtime.getSetting("INSTAGRAM_APP_SECRET") ||
				process.env.INSTAGRAM_APP_SECRET,

			INSTAGRAM_BUSINESS_ACCOUNT_ID:
				runtime.getSetting("INSTAGRAM_BUSINESS_ACCOUNT_ID") ||
